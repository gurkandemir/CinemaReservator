...
public class DatabaseConnection {
    ...
    public void initializeDatabase() throws SQLException{
        ...
        try{
            ...
            insertPreparedStatement.setInt(1, 1);
            insertPreparedStatement.setString(2, "Karakomik Filmler");
            insertPreparedStatement.setString(3, "15.00");
            insertPreparedStatement.setString(4, "Cem Yılmaz");
            insertPreparedStatement.setInt(5, 1);
            insertPreparedStatement.executeUpdate();
            numberOfFilms++;
            insertPreparedStatement.setInt(1, 2);
            insertPreparedStatement.setString(2, "Yedinci Kogustaki Mucize");
            insertPreparedStatement.setString(3, "18.00");
            insertPreparedStatement.setString(4, "Mehmet Ada Öztekin");
            insertPreparedStatement.setInt(5, 1);
            insertPreparedStatement.executeUpdate();
            numberOfFilms++;
            insertPreparedStatement.setInt(1, 3);
            insertPreparedStatement.setString(2, "Recep Ivedik 6");
            insertPreparedStatement.setString(3, "21.00");
            insertPreparedStatement.setString(4, "Togan Gokbakar");
            insertPreparedStatement.setInt(5, 1);
            insertPreparedStatement.executeUpdate();
            numberOfFilms++;
